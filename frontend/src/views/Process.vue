  ...
  <div class="process-page">
    ...
    <nav class="navbar">
      ...
      <div class="nav-center">
        ...
        <div class="step-name">Intelligence Mapping</div>
      </div>
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        <div class="panel-header">
          <div class="header-left">
            <svg class="header-deco-svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="graph-container" ref="graphContainer">
          <!-- Graph visualization (displayed as soon as there's data) -->
        ...
        <div class="process-content">
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
            <div class="phase-header">
              ...
              <div class="phase-info">
                <div class="phase-title">Strategic Schema Alignment</div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  Upon processing intelligence briefings, the strategic engine aligns context and automatically orchestrates a structural schema optimized for high-fidelity wargaming.
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            <div class="phase-header">
              ...
              <div class="phase-info">
                <div class="phase-title">Intelligence Mapping</div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Guided by the strategic schema, intelligence units are mapped via deep-context analysis to construct a synthetic battlefield environment.
                </div>
              </div>
...
const statusText = computed(() => {
  if (error.value) return 'Strategic Mapping Failed'
  if (currentPhase.value >= 2) return 'Intelligence Map Ready'
  if (currentPhase.value === 1) return 'Mapping Battlefield'
  if (currentPhase.value === 0) return 'Aligning Strategic Schema'
  return 'Mobilizing'
})
...
const loadProject = async () => {
  try {
    ...
    if (response.success) {
      ...
      // Continue polling for tasks in progress
