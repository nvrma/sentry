<template>
  <div class="env-setup-panel">
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Engagement Initialization</span>
          </div>
        ...
        <div class="card-content">
          ...
          <p class="description">
            Orchestrate wargaming instance, initialize battlefield parameters and intelligence context.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Mobilize Strategic Actors</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Synthesizing intelligence from the mapping phase, the engine automatically initializes strategic actors with high-fidelity behavioral profiles, unique tactical memories, and objective-driven personas.
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Related Topics from Real-world Seeds</span>
            </div>
          </div>
          ...
          <div v-if="profiles.length > 0" class="profiles-preview">
            <div class="preview-header">
              <span class="preview-title">Mobilized Strategic Actors</span>
            </div>
      ...
      <!-- Step 03: Generate Multi-Platform Simulation Config -->
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          <div class="step-info">
            <span class="step-num">03</span>
            <span class="step-title">Engagement Logic & Algorithm Orchestration</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            The strategic engine orchestrates the logical parameters of the engagement: temporal flow, algorithmic recommendation biases, actor engagement frequencies, and tactical event triggers.
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                ...
                <div class="config-item">
                  <span class="config-item-label">Mins/Round</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Tactical Engagement Deployment</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Based on strategic narrative guidance, the engine deploys initial tactical events and catalyst topics to activate the battlefield environment.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase >= 4" class="badge processing">Running</span>
            <span v-else class="badge pending">Pending</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          <p class="description">Simulation environment ready, start simulation running</p>
          
          <!-- Simulation Rounds Config - Visible only after config generation and round calculation -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">Wargaming Engagement Duration</span>
                <span class="section-desc">The strategic engine has orchestrated an engagement spanning <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> tactical hours, with each round representing <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of operational time.</span>
              </div>
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">For first run, it's strongly recommended to switch to 'Custom Mode' to reduce rounds for quick preview and low error risk ➝</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="modal-body">
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              ...
              <div class="dimension-card">
                <span class="dim-title">Behavioral Patterns Profile</span>
...
const customMaxRounds = ref(40)   // Recommended 40 rounds by default
...
watch(currentStage, (newStage) => {
  if (newStage === 'Generate Agent Personas' || newStage === 'generating_profiles') {
    ...
    if (!configTimer) {
      addLog('Starting multi-platform simulation config generation...')
      startConfigPolling()
    }
...
// Calculate auto-generated rounds from config (don't use hardcoded defaults)
const autoGeneratedRounds = computed(() => {
  ...
  // Ensure max rounds not less than 40 (recommended value), avoid range issues
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    addLog(`Simulation started, custom rounds: ${customMaxRounds.value} rounds`)
  } else {
    // User chose to keep auto-generated rounds, don't pass max_rounds parameter
    addLog(`Simulation started, using auto-config rounds: ${autoGeneratedRounds.value} rounds`)
  }
...
// Automatically start prepare simulation
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Existing preparation work detected, using it directly')
...
const fetchProfilesRealtime = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Only update when API returns valid value, avoid overwriting valid data
...
const loadPreparedData = async () => {
  ...
  // Fetch config (using real-time interface)
  try {
    const res = await getSimulationConfigRealtime(props.simulationId)
    if (res.success && res.data) {
