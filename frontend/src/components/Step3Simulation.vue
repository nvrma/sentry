  ...
  <div class="simulation-panel">
    ...
    <div class="control-bar">
      <div class="status-group">
        ...
        <div class="platform-status reddit" :class="{ active: runStatus.reddit_running, completed: runStatus.reddit_completed }">
          <div class="platform-header">
            ...
            <span class="platform-name">Strategic Community Hub</span>
      ...
      <div class="action-controls">
        ...
        >
          ...
          {{ isGeneratingReport ? 'Analyzing...' : 'Initialize Consequence Analysis' }} 
    ...
    <div class="main-content-area" ref="scrollContainer">
      ...
      <div class="timeline-header" v-if="allActions.length > 0">
        <div class="timeline-stats">
          <span class="total-count">TOTAL TACTICAL EVENTS: <span class="mono">{{ allActions.length }}</span></span>
          ...
          >
            ...
            <div class="timeline-card">
              ...
              <div class="card-body">
                ...
                <!-- General fallback: unknown type or content not covered above -->
    ...
    <div class="system-logs">
      <div class="log-header">
        <span class="log-title">TACTICAL OPERATIONS MONITOR</span>
...
// Action counts for each platform
...
// Plaza platform simulation elapsed time
const twitterElapsedTime = computed(() => {
  return formatElapsedTime(runStatus.value.twitter_current_round || 0)
})

// Community platform simulation elapsed time
...
const doStartSimulation = async () => {
  ...
  // Reset all state first to ensure it's not affected by the previous simulation
  resetAllState()
  
  isStarting.value = true
  startError.value = null
  addLog('Orchestrating dual-platform strategic engagement...')
  ...
  try {
    ...
    if (props.maxRounds) {
      params.max_rounds = props.maxRrounds
      addLog(`Maximum simulation rounds set: ${props.maxRounds}`)
    }
...
// Track last round of each platform for detecting changes and logging
...
const fetchRunStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Detect if simulation is finished (via runner_status or platform completion status)
...
// Check if all enabled platforms are finished
...
onMounted(() => {
  addLog('Theatre Monitoring initialization complete')
  if (props.simulationId) {
    doStartSimulation()
  }
})
...
.timeline-item.twitter .marker-dot { background: var(--orange); }
.timeline-item.reddit .marker-dot { background: var(--orange); }
.timeline-item.twitter .timeline-marker { border-color: var(--orange); }
.timeline-item.reddit .timeline-marker { border-color: var(--orange); }
...
.log-msg { color: var(--dashboard-text); word-break: break-all; }
