      ...
      <div class="right-panel" ref="rightPanel">
        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-text">
            <span class="action-bar-title">Tactical Query Interface</span>
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Consult Strategic Analyst</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Engage Strategic Actor' }}</span>
                <svg class="dropdown-arrow" :class="{ open: showAgentDropdown }" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </button>
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">Select Actor</div>
                <div 
            ...
            >
              ...
              <span>Broadscale Intelligence Poll</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                <div class="tools-card-name">Strategic Analyst Consultation</div>
                <div class="tools-card-subtitle">Direct line to the primary analyst, utilizing deep wargaming archives and real-time inference.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Deep attribution analysis across time and space, combining Global/Local Memory mechanisms</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch Overview</div>
                    <div class="tool-desc">Graph-based traversal algorithm to reconstruct event propagation paths and capture information flow topology</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface for fast extraction of node attributes and facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interview agent capable of parallel multi-turn dialogues to collect unstructured views</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Consult the Strategic Analyst for contingency insights' : 'Engage with strategic actors to gauge their perceived consequences' }}
              </p>
            </div>
            <div 
              ...
              <div class="message-content">
                <div class="message-header">
                  <span class="sender-name">
                    {{ msg.role === 'user' ? 'Operator' : (chatTarget === 'report_agent' ? 'Strategic Analyst' : (selectedAgent?.username || 'Actor')) }}
                  </span>
        ...
        <div v-if="activeTab === 'survey'" class="survey-container">
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Select Strategic Targets</span>
            ...
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Intelligence Query</span>
              </div>
              <textarea 
                v-model="surveyQuestion"
                class="survey-input"
                placeholder="Enter the tactical query you wish to propagate across selected actors..."
                rows="3"
              ></textarea>
            </div>
            ...
            >
              ...
              <span v-else>Propagate Intelligence Query</span>
            </button>
          </div>
          ...
          <div v-if="surveyResults.length > 0" class="survey-results">
            <div class="results-header">
              <span class="results-title">Intelligence Responses</span>
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`Target selected: ${agent.username}`)
}
...
const renderMarkdown = (content) => {
  ...
  // Clean <br> before paragraph start tags immediately following block elements
...
const sendToReportAgent = async (message) => {
  addLog(`Consulting Strategic Analyst: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    ...
    addLog('Strategic Analyst provided assessment')
  } else {
...
const sendToAgent = async (message) => {
  ...
  addLog(`Engaging ${selectedAgent.value.username}: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    ...
    // Convert object dictionary to array, prioritize getting Reddit responses
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prioritize Reddit response, then Twitter
    ...
    if (responseContent) {
      ...
      addLog(`${selectedAgent.value.username} provided feedback`)
    } else {
...
/* Quote styling for chat/survey area */
