...
def to_pascal_case(s: str) -> str:
    """Convert string to PascalCase without losing existing casing in the middle."""
    if not s:
        return s
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for entity in result["entity_types"]:
            # Enforce PascalCase for entity names
            original_name = entity.get("name", "")
            entity["name"] = to_pascal_case(original_name)
        ...
        for edge in result["edge_types"]:
            # Enforce UPPER_SNAKE_CASE for edge names as per prompt, 
            # but Zep might require PascalCase for some parts.
            # However, the error log says "name must be in PascalCase format"
            # let's enforce PascalCase for edge names as well if they are used as classes.
            original_edge_name = edge.get("name", "")
            edge["name"] = to_pascal_case(original_edge_name)
            
            if "source_targets" not in edge:
                edge["source_targets"] = []
            
            # Enforce PascalCase for source and target
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        ...
        code_lines = [
            ...
            'Automatically generated by Sentry for social public sentiment simulation',
            '"""',
            '',
