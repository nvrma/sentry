...
3. Flask polls the responses directory to get the result
"""
...
logger = get_logger('sentry.simulation_ipc')
...
class SimulationIPCClient:
    ...
    Used to send commands to the simulation process and wait for a response
    """
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specific platform (optional)
                ...
                - None: Interview both platforms if dual-platform simulation, or the single platform in a single-platform simulation
            timeout: Timeout
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by platform within each interview item)
