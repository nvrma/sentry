...
Manages parallel simulations for both Twitter and Reddit platforms
...
logger = get_logger('sentry.simulation')
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Args:
            ...
            document_text: Raw document content (used for LLM background context)
        ...
        try:
            ...
            profiles = generator.generate_profiles_from_entities(
                ...
                output_platform=realtime_platform  # Output platform format
            )
            ...
            # When simulation starts, simulation_runner will run the script from scripts/ directory
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                f"1. Activate conda environment: conda activate Sentry\n"
