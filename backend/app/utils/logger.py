...
def _ensure_utf8_stdout():
    ...
    Fixes Chinese character garbling in Windows console
    """
...
def setup_logger(name: str = 'sentry', level: int = logging.DEBUG) -> logging.Logger:
    """
    Setup logger
    ...
    # Ensure UTF-8 encoding is used on Windows to avoid garbled Chinese
    _ensure_utf8_stdout()
