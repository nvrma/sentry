...
Used to persist project state on the server side, avoiding passing large amounts of data between frontend interfaces
"""
...
class ProjectManager:
    ...
    def list_projects(cls, limit: int = 50) -> List[Project]:
        ...
        Args:
            limit: Limit of the number of items to return
